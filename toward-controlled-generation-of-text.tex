...
\begin{frame}{Experiments}
  ...
  \begin{itemize}
    \item \textbf{Stanford Sentiment Treebank-2}: 2837 training examples with sentence length $\leq 15$ \& binary sentiment annotations.
    \item \textbf{Sentiment Lexicon}:  2700 words with sentiment labels. The lexicon is used for training by treating the words as sentences.
